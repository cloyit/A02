...
module system_wrapper
  ...
  system system_i
       (.DDR_addr(DDR_addr),
        ...
        .emio_sccb_tri_i({emio_sccb_tri_i_4,emio_sccb_tri_i_3,emio_sccb_tri_i_2,emio_sccb_tri_i_1,emio_sccb_tri_i_0}),
        .emio_sccb_tri_o({emio_sccb_tri_o_4,emio_sccb_tri_o_3,emio_sccb_tri_o_2,emio_sccb_tri_o_1,emio_sccb_tri_o_0}),
        .emio_sccb_tri_t({emio_sccb_tri_t_4,emio_sccb_tri_t_3,emio_sccb_tri_t_2,emio_sccb_tri_t_1,emio_sccb_tri_t_0}),
        .key0(key0),
        .key1(key1),
        .lcd_bl(lcd_bl),
        .lcd_clk(lcd_clk),
