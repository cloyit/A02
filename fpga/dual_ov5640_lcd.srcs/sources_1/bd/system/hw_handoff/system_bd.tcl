...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set aclcho [ create_bd_port -dir O -from 0 -to 0 aclcho ]
  ...
  set key0 [ create_bd_port -dir I -type ce key0 ]
  set_property -dict [ list \
   CONFIG.POLARITY {ACTIVE_HIGH} \
 ] $key0
  set key1 [ create_bd_port -dir I -type ce key1 ]
  set_property -dict [ list \
   CONFIG.POLARITY {ACTIVE_HIGH} \
 ] $key1
  set lcd_bl [ create_bd_port -dir O lcd_bl ]
  set lcd_rst [ create_bd_port -dir O -type rst lcd_rst ]
  set tired [ create_bd_port -dir O -from 0 -to 0 tired ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M06_AXI [get_bd_intf_pins ov5640_rgb2gray_0/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M06_AXI]
  ...
  connect_bd_net -net key1_1 [get_bd_ports key1] [get_bd_pins util_vector_logic_1/Op1]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dynclk_0/s00_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins axi_interconnect_0/S03_ARESETN] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins axi_vdma_1/axi_resetn] [get_bd_pins ov5640_rgb2gray_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins v_osd_0/aresetn] [get_bd_pins v_osd_0/s_axi_aresetn] [get_bd_pins v_tc_0/s_axi_aresetn]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_ports aclcho] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net util_vector_logic_1_Res [get_bd_ports tired] [get_bd_pins util_vector_logic_1/Res]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ov5640_rgb2gray_0/s_axi_AXILiteS/Reg] SEG_ov5640_rgb2gray_0_Reg
