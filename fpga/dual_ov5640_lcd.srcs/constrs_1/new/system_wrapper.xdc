...
set_property IOSTANDARD LVCMOS33 [get_ports {aclcho[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {tired[0]}]
set_property PACKAGE_PIN K14 [get_ports {aclcho[0]}]
set_property PACKAGE_PIN J14 [get_ports {tired[0]}]

set_property PACKAGE_PIN M15 [get_ports UART_1_0_rxd]
set_property PACKAGE_PIN L16 [get_ports UART_1_0_txd]
set_property IOSTANDARD LVCMOS33 [get_ports UART_1_0_rxd]
set_property IOSTANDARD LVCMOS33 [get_ports UART_1_0_txd]
set_property PACKAGE_PIN U19 [get_ports {emio_sccb_tri_io[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {emio_sccb_tri_io[4]}]
