...
//		sccb_write_reg16(cmos_ch,0x3036,0x3c); //PLL倍频  //48M
		...
		//颜色调整
		sccb_write_reg16(cmos_ch,0x3406,0x1); //0x00:正常模式 0x80:彩条显示
		sccb_write_reg16(cmos_ch,0x3400,0x6);
		sccb_write_reg16(cmos_ch,0x3401,0x48);
		sccb_write_reg16(cmos_ch,0x3403,0x4); //打开闪光灯
		sccb_write_reg16(cmos_ch,0x3403,0x0); //打开闪光灯
		sccb_write_reg16(cmos_ch,0x3404,0x4); //关闭闪光灯
		sccb_write_reg16(cmos_ch,0x3405,0xd3); //关闭闪光灯
		return 0;
	}
