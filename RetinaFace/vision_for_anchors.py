...
class Anchors(object):
    ...
    def get_anchors(self):
        ...
        output_copy  = output
        output[:,0] = output_copy[:,0] - output_copy[:,2] / 2
        output[:,1] = output_copy[:,1] - output_copy[:,3] / 2
        output[:,2] = output_copy[:,0] + output_copy[:,2] / 2
        output[:,3] = output_copy[:,1] + output_copy[:,3] / 2
